...
class Biggopties {
	...
	public function enqueue_admin_scripts() {
		wp_enqueue_style('usk-admin-biggopti', BDTUSK_ADMIN_URL . 'assets/css/admin-biggopti.css', [], BDTUSK_VER);
		wp_enqueue_style('bdt-admin-api-biggopti', BDTUSK_ADMIN_URL . 'assets/css/admin-api-biggopti.css', [], BDTUSK_VER);
		wp_enqueue_style('bdt-product-feed', BDTUSK_ADMIN_URL . 'assets/css/product-feed.css', [], BDTUSK_VER);
	}
