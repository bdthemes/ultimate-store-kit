...
(function ($, elementor) {
  ...
  $(document).on("click", ".usk-modal-page .usk-modal-product .images a", function (e) {
    e.preventDefault();
    var img_url = $(this).attr("data-href");
  ...
  $(".elementor-widget-usk-florence-grid").on("click", ".usk-pagination a", function (b) {
    b.preventDefault();
    ...
    $.ajax({
      ...
      success: function (response) {
        if (response.action === "added") {
          ...
          $(".usk-wishlist-button").find(".usk-wishlist-count").html(response.count);
          $this.attr({
            href: $redirect_url
          });
        }
  ...
  $(".ajax_add_to_compare").on("click", function (e) {
    ...
    $.ajax({
      ...
      success: function (response) {
        if (response.action === "added") {
          $this.addClass("usk-active").attr("aria-label", $area_label);
          $(".usk-compare-button").find(".usk-compare-count").html(response.count);
          $this.attr({
            href: $redirect_url
          });
        }
...
/******/ })()
;
//# sourceMappingURL=usk-core.js.map