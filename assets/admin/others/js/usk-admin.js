/******/ (() => { // webpackBootstrap
/*!******************************************!*\
  !*** ./src/admin/others/js/usk-admin.js ***!
  \******************************************/
jQuery(document).ready(function ($) {
  ...
  const variationDependentOptions = variationSwatchesBtn.length > 0 ? variationSwatchesBtn.closest(".usk-option-item").nextAll() : jQuery('.usk-option-item[class*="bdt-usk_variation_swatches_"]');
