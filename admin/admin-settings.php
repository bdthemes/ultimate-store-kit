...
class UltimateStoreKit_Admin_Settings {
						...
						<div class="bdt-count-canvas-wrap bdt-flex bdt-flex-between">
							...
							<div class="bdt-canvas-wrap">
								<canvas id="bdt-db-total-status" style="height: 120px; width: 120px;"
									data-label="Total Widgets Status - (<?php echo esc_attr( $used_widgets ) + esc_attr( $un_used_widgets ); ?>)"
						...
						<div class="bdt-count-canvas-wrap bdt-flex bdt-flex-between">
							...
							<div class="bdt-canvas-wrap">
								<canvas id="bdt-db-only-widget-status" style="height: 120px; width: 120px;"
									data-label="WooCommerce Widgets Status - (<?php echo esc_attr( $used_only_widgets ) + esc_attr( $unused_only_widgets ); ?>)"
									data-labels="<?php echo esc_attr( 'Used, Unused' ); ?>"
					...
					<div class="bdt-widget-status bdt-card bdt-card-body" <?php echo wp_kses_post( $track_nw_msg ); ?>>
						...
						<div class="bdt-count-canvas-wrap bdt-flex bdt-flex-between">
							<div class="bdt-count-wrap">
								...
								<div class="bdt-widget-count">Total:
									<b><?php echo esc_html( $used_only_edd_widgets ) + esc_html( $unused_only_edd_widgets ); ?></b>
								</div>
							</div>

							<div class="bdt-canvas-wrap">
								<canvas id="bdt-db-only-edd_widgets-status" style="height: 120px; width: 120px;"
									data-label="EDD Widgets Status - (<?php echo esc_attr( $used_only_edd_widgets ) + esc_attr( $unused_only_edd_widgets ); ?>)"
									data-labels="<?php echo esc_attr( 'Used, Unused' ); ?>"
									data-value="<?php echo esc_attr( $used_only_edd_widgets ) . ',' . esc_attr( $unused_only_edd_widgets ); ?>"
						...
						<div class="bdt-count-canvas-wrap bdt-flex bdt-flex-between">
							...
							<div class="bdt-canvas-wrap">
								<canvas id="bdt-total-widgets-status" style="height: 120px; width: 120px;"
									data-label="Total Active Widgets Status" data-labels="<?php echo esc_attr( 'WooCommerce, EDD' ); ?>"
				...
				<div class="bdt-width-1-3@m bdt-support-section">
					<div class="bdt-support-content bdt-card bdt-card-body">
						...
						<p>Feeling like to consult with an expert? Take live Chat support immediately from <a
								href="https://storekit.pro/" target="_blank" rel="">UltimteStoreKit</a>. We are always
							ready to help
							you 24/7.</p>
						...
						<a class="bdt-button bdt-btn-blue bdt-margin-small-top bdt-margin-small-right" target="_blank" rel=""
							href="https://bdthemes.com/all-knowledge-base-of-ultimate-store-kit/">Knowledge
							Base</a>
						<a class="bdt-button bdt-btn-grey bdt-margin-small-top" target="_blank" href="https://bdthemes.com/support/">Get
							Support</a>
					</div>
				</div>
				...
				<div class="bdt-width-1-2@m">
					<div class="bdt-card bdt-card-body bdt-tryaddon-bg">
						...
						<p style="max-width: 520px;">
							<b>Element Pack, Prime Slider, Ultimate Post Kit, Pixel Gallery & Live Copy Paste </b> addons for
							<b>Elementor</b> is the best slider, blogs and eCommerce plugin for WordPress.
						</p>
						<div class="bdt-others-plugins-link">
							...
							<a class="bdt-button bdt-btn-ps bdt-margin-small-right" target="_blank" rel=""
								href="https://wordpress.org/plugins/bdthemes-prime-slider-lite/" bdt-tooltip="">Prime Slider</a>
	...
	function ultimate_store_kit_system_requirement() {
		...
		<div class="bdt-admin-alert">
			<strong><?php esc_html_e( 'Note:', 'ultimate-store-kit' ); ?></strong>
			<?php esc_html_e( 'If you have multiple addons like' ); ?>
			<b><?php esc_html_e( 'Ultimate Store Kit', 'ultimate-store-kit' ); ?></b>
	...
	function footer_info() {
		...
		<div class="ultimate-store-kit-footer-info">
			<p><?php esc_html_e( 'Ultimate Store Kit Addon made with love by', 'ultimate-store-kit' ); ?> <a target="_blank"
					href="https://bdthemes.com"><?php esc_html_e( 'BdThemes', 'ultimate-store-kit' ); ?></a>
				<?php esc_html_e( 'Team.', 'ultimate-store-kit' ); ?> <br><?php esc_html_e( 'All
