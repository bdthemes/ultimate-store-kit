...
class Ultimate_Store_Kit_Loader {
	...
	public function enqueue_site_scripts() {
		...
		wp_register_script('usk-core', BDTUSK_ASSETS_URL . 'js/usk-core.js', ['jquery'], BDTUSK_VER, true); // tooltip file should be separate
		// wp_register_script('usk-site', BDTUSK_ASSETS_URL . 'js/usk-site.js', ['jquery'], BDTUSK_VER, true); // tooltip file should be separate
	...
	public function enqueue_editor_scripts() {
		...
		wp_register_script('usk-editor', BDTUSK_ASSETS_URL . 'js/usk-editor.js', ['backbone-marionette', 'elementor-common-modules', 'elementor-editor-modules',], BDTUSK_VER, true);
	...
	public function enqueue_admin_scripts() {
		wp_register_script('usk-admin', BDTUSK_ASSETS_URL . 'js/usk-admin.js', ['jquery'], BDTUSK_VER, true);
