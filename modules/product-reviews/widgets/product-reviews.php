...
class Product_Reviews extends Module_Base {
    ...
    <?php
        ...
        <div class="usk-review-avatar-image">
            <a href="#">
                <img src="<?php echo esc_url(wp_get_attachment_image_url(get_post_thumbnail_id(), $settings['image_size'])); ?>" alt="<?php echo get_the_title(); ?>">
            </a>
        </div>
        <?php
            }
                        ...
                        <div class="usk-review-avatar-wrapper">
                            ...
                            <div class="usk-review-content">
                                ...
                                if ($settings['show_title']) :
                                    printf('<%1$s class="usk-review-title"><a href="%3$s">%2$s</a></%1$s>', esc_attr($settings['title_tags']), $product->get_name(), $product->get_permalink());
                                endif; ?>
